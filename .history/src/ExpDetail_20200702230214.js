    ...
    <div className="expDetail">
      <div style={{ backgroundColor: "black", height: "70vh" }}>
        <Container>
          <Row>
            <Col sm={3}>
              <img alt="" src={data[0].images[0]} width="340" height="458"></img>
            </Col>
            <Col sm={3}>
              <img alt="" src={data[0].images[1]} width="340" height="458"></img>
            </Col>
            ...
            <Col sm={3}>
              <img alt="" src={data[0].images[4]} width="340" height="458"></img>
            </Col>
          </Row>
        </Container>
      </div>
