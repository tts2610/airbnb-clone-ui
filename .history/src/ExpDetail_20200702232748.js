      ...
      <div style={{ backgroundColor: "black", padding: "15px" }}>
        <Container>
          ...
          <StackGrid columnWidth={150}>
            <div>
              <img alt="" src={data[1].images[0]}></img>
            </div>
            <div>
              <img alt="" src={data[1].images[1]}></img>
            </div>
            <div>
              <img alt="" src={data[1].images[2]}></img>
            </div>
            <div>
              <img alt="" src={data[1].images[3]}></img>
            </div>
            <div>
              <img alt="" src={data[1].images[4]}></img>
            </div>
          </StackGrid>
        </Container>
      </div>
