...
export default function ExpDetail() {
  ...
  useEffect(() => {
    ...
    axios.get(process.env.REACT_APP_GET_USER_URL).then((res) => console.log(res.data.data.userList));
  }, []);
    ...
    <div className="expDetail">
      <Navbar bg="light" expand="lg">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav>
            {(isHost || localStorage.getItem(process.env.REACT_APP_LOCAL_STORAGE_USER_HOST)) && users.some((e) => e.email === localStorage.getItem(process.env.REACT_APP_LOCAL_STORAGE_USER_EMAIL)) && (
