  ...
  signUpUser = (email, name, password, introduction, country) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        this.setState({ showSignUpSpinner: false, showLogin: false });
      })
  ...
  render() {
    return (
      <>
        ...
        <SignupModal show={this.state.showSignUp} handleClose={this.handleClose} signUpUser={this.signUpUser} showSpinner={this.state.showSignUpSpinner} />
      </>
    );
  }
}
