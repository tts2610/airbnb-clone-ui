...
export default function Home() {
  ...
  const performFilter = async (params) => {
    let searchUrl = process.env.REACT_APP_GET_EXP + `/search?priceMin=${params.minPrice}&priceMax=${params.maxPrice}&languages=${params.languages}&tags=${params.tags}`;
  ...
  }, [searchParams, getExps, performFilter]);
