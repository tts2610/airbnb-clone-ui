...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // }
    // getExps();
    let searchUrl = process.env.REACT_APP_GET_EXP + `/search?priceMin=${searchParams.minPrice ? searchParams.minPrice : ""}&priceMax=${params.maxPrice ? params.maxPrice : ""}&languages=${params.languages}&tags=${params.tags}`;
    axios
      .get(searchUrl)
