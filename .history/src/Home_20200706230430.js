...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // }
    // getExps();
    let searchUrl = process.env.REACT_APP_GET_EXP + `/search?priceMin=${searchParams.minPrice ? searchParams.minPrice : ""}&priceMax=${searchParams.maxPrice ? searchParams.maxPrice : ""}&languages=${searchParams.languages}&tags=${searchParams.tags}`;
    axios
      .get(searchUrl)
      .then((res) => setData(res.data.data))
      .then((res) => getLanguageList());
  }, [searchParams, getLanguageList]);
