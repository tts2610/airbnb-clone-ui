  ...
  return (
    <>
      ...
      <Container className="mt-5">
        ...
        {data.length!==0?<CardDeck style={{ justifyContent: "center" }}>
          {data.map((item, idx) => (
            <ExpCard key={idx} {...item} />
          ))}
        </CardDeck>:<div style="width:100%;height:0;padding-bottom:74%;position:relative;"><iframe src="https://giphy.com/embed/fKk2I5iiWGN0I" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/rip-alan-rickman-he-will-be-missed-fKk2I5iiWGN0I">via GIPHY</a></p>}
