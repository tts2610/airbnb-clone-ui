...
export default function Home() {
  ...
  useEffect(() => {
    let searchUrl =
      ...
      `/search?priceMin=${searchParams.minPrice ? searchParams.minPrice : ""}&priceMax=${searchParams.maxPrice ? searchParams.maxPrice : ""}&languages=${searchParams.languages}&tags=${searchParams.tags}&page=${searchParams.page}&perPage=12`;
