...
export default function ExpCard({ title, price, location, images }) {
    return ( <
        ...
        /Col> <
        Col style = {
            { display: "flex", alignItems: "center", justifyContent: "flex-end" } } > { /* <i className="fad fa-heart-circle fa-2x"></i> */ } <
        ...
        Card.Body >
        <
        Card.Text className = "text-uppercase" > { location } < /Card.Text> <
        Card.Text className = "cardTitle" > { title } < /Card.Text> <
        Card.Text > From $ { price }
        /person</Card.Text >
        <
        /Card.Body> <
        /Card> <
