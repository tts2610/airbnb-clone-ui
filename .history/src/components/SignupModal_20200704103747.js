    ...
    <div>
      <Modal show={show}>
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={() => signUpUser(email, name, password, introduction, country)}>
            {showSpinner && !hideSpinner && <Spinner as="span" animation="border" size="sm" role="status" aria-hidden="true" />}
            Sign up
          </Button>
        </Modal.Footer>
      </Modal>
