        ...
        <Modal.Body>
          <Form>
            <Form.Group>
              ...
              <Form.Control value={show ? email : ""} onChange={(e) => setEmail(e.target.value)} type="email" placeholder="Enter email" />
            </Form.Group>
            <Form.Group>
              <Form.Label>
                {" "}
              ...
              <Form.Control value={show ? name : ""} onChange={(e) => setName(e.target.value)} type="text" placeholder="Enter name" />
            </Form.Group>
            <Form.Group>
              <Form.Label>
                {" "}
              ...
              <Form.Control value={show ? password : ""} onChange={(e) => setPassword(e.target.value)} type="password" placeholder="Password" />
            </Form.Group>
            <Form.Group>
              <Form.Label>
                {" "}
            ...
            <Form.Group>
              ...
              <Form.Control value={show ? introduction : ""} onChange={(e) => setIntroduction(e.target.value)} as="textarea" rows="3" />
            </Form.Group>
            <Form.Group>
              <Form.Label> Country </Form.Label> <Form.Control value={show ? country : ""} onChange={(e) => setCountry(e.target.value)} type="text" placeholder="Country" />
            </Form.Group>
          </Form>
