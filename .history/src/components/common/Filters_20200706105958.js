  ...
  return (
    <Container>
      <Row>
        ...
        <Col sm={2} className="mt-2">
          <Multiselect options={timeOfDay} selectedValues={selectedOption} onSelect={handleChange} displayValue="name" showCheckbox={true} placeholder="Time of day" closeOnSelect={false} avoidHighlightFirstOption={true} closeIcon="close" />
        </Col>
        <Col sm={2} className="mt-2">
