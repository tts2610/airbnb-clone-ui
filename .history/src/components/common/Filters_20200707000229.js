...
export default function Filters() {
  ...
  useEffect(() => {
    axios.get(process.env.REACT_APP_GET_EXP).then((res) => setData(res.data.data));
  ...
  const handleSelectTag = (selectedList) => {
    ...
    // dispatch({ type: "FILTER", payload: { searchParams: { tags: selectedList.map((e) => languageConvert[e.name]) } } });
    // filterByLanguage();
  };
