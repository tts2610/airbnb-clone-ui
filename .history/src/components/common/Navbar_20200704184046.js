...
export default function CustomNavbar({ handleShow }) {
  ...
  const signOut = () => {
    const headers = {
      Authorization: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI1ZjAwNTc3YTIxNzk4YzAwMTdkNWMwYWIiLCJpYXQiOjE1OTM4NTc5MTQsImV4cCI6MTU5NTA2NzUxNH0.ellA5hLh1CG6ir8_Nfq4vm_qXv6J1np8e1USZyLaH-0",
    };
    axios
