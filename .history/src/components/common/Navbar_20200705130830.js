...
let userToken = localStorage.getItem(process.env.REACT_APP_LOCAL_STORAGE_USER_TOKEN);
let userEmail = localStorage.getItem(process.env.REACT_APP_LOCAL_STORAGE_USER_EMAIL);
